...
<body>
<?php
//Jos käyttäjä on normaali, includataan normaalinavi, saatavuus-sivu ja asetetaan saatavuuspainike aktiiviseksi.
date_default_timezone_set("Europe/Helsinki");
if (isset($_SESSION['kayttaja']) && !empty($_SESSION['kayttaja'])) {
	if ($_SESSION['kayttaja'] == "normaali") {
		include('navi.php');
		include('saatavuus.php');
		?>
		<script>$('li.saatavuus').addClass("active");</script>
		<?php
	}
	//Jos käyttäjä on admin, includataan adminin navi, saatavuus-sivu ja asetetaan saatavuuspainike aktiiviseksi.
