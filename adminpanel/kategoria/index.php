...
<body>
<?php
//Jos käyttäjä on normaali, includataan normaalinavi sekä kategoriasivu ja tehdään kategoriapainikkeesta aktiivinen.
...
if (isset($_SESSION['kayttaja']) && !empty($_SESSION['kayttaja'])) {
	if ($_SESSION['kayttaja'] == "normaali") {
		...
		?>
		<script>$('li.kategoria').addClass("active");</script>
		<?php
	}
	//Jos käyttäjä on admin, includataan adminin navi sekä kategoriasivu ja tehdään kategoriapainikkeesta aktiivinen.
