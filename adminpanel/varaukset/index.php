...
<?php
//Jos käyttäjä on admin, includataan admin css. Muussa tapauksessa normaali css.
...
<body>
<?php
//Jos käyttäjä on normaali, includataan normaalinavi ja etusivu sekä tehdään varaukset-napista aktiivinen.
date_default_timezone_set("Europe/Helsinki");
if (isset($_SESSION['kayttaja']) && !empty($_SESSION['kayttaja'])) {
	if ($_SESSION['kayttaja'] == "normaali") {
		include('navi.php');
		include('varaukset.php');
		?>
		<script>$('li.varaukset').addClass("active");</script>
		<?php
	}
	//Jos käyttäjä on admin, includataan adminin navi ja etusivu sekä tehdään varaukset-napista aktiivinen.
...
//Muussa tapauksessa näytetään nappi, joka vie kirjautumissivulle.
else {
