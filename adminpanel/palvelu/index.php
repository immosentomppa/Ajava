...
//Muussa tapauksesa includataan normaali css.
else {
...
<body>
<?php
//Jos käyttäjä on normaali, includataan normaalinavi, palvelusivu ja tehdään palvelunapista aktiivinen.
...
if (isset($_SESSION['kayttaja']) && !empty($_SESSION['kayttaja'])) {
	if ($_SESSION['kayttaja'] == "normaali") {
		...
		include('palvelu.php');
		?>
		<script>$('li.palvelu').addClass("active");</script>
		<?php
	}
	//Jos käyttäjä on admin, includataan adminin navi, palvelusivu ja tehdään palvelunapista aktiivinen.
...
//Muussa tapauksessa tulostetaan kirjautumissivulle ohjaava painike.
else {
