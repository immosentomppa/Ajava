...
//Muussa tapauksessa normaali css.
else {
...
<body>
<?php
//Jos käyttäjä on normaalikäyttäjä, includataan normaalinavi, työntekijätoiminnot ja asetetaan työntekijänappi aktiiviseksi.
...
if (isset($_SESSION['kayttaja']) && !empty($_SESSION['kayttaja'])) {
	if ($_SESSION['kayttaja'] == "normaali") {
		...
		?>
		<script>$('li.tyontekija').addClass("active");</script>
		<?php
	}
	//Jos käyttäjä on admin, includataan adminin navi, työntekijätoiminnot ja asetetaan työntekijänappi aktiiviseksi.
