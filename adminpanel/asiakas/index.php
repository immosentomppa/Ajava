...
//Muussa tapauksessa includataan normaalicss.
else {
...
<body>
<?php
//Jos käyttäjä on normaali, includataan normaalinavi sekä asiakas-sivu ja tehdään asiakas-painikkeesta aktiivinen.
...
if (isset($_SESSION['kayttaja']) && !empty($_SESSION['kayttaja'])) {
	if ($_SESSION['kayttaja'] == "normaali") {
		...
		include('asiakas.php');
		?>
		<script>$('li.asiakas').addClass("active");</script>
		<?php
	}
	//Jos käyttäjä on admin, includataan adminin navi sekä asiakas-sivu ja tehdään asiakas-painikkeesta aktiivinen.
